    ...
    <div>
      ...
      <section className="min-h-[90vh] flex">
        ...
        <article className="w-[25%] overflow-auto max-h-[90vh] h-full bg-white border-gray-200">
          ...
          {punchNotifications?.arrayOfEmployee?.map(
            (employee, idx) =>
              employee && (
                <Link
                  onClick={() => handleEmployeeClick(employee?._id)} // Click handler
                  to={`/punch-notification/${employee?._id}`}
                  className={`px-6 my-1 mx-3 py-2 flex gap-2 rounded-md items-center hover:bg-gray-50 ${employee?._id === employeeId ? "bg-blue-500 text-white hover:!bg-blue-300" : ""
                    }`}
                  key={idx}
                >
                  <Avatar />
                  <div>
                    ...
                    <h1 className={`text-sm text-gray-500 ${employee?._id === employeeId ? "text-white" : ""}`}>
                      {employee?.email}
                    </h1>
                  </div>
                </Link>
              ...
              <>
                <div className="p-4 space-y-1 flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl">Punch Requests</h1>
                    <p className="text-sm">
                      Here you will be able to approve or reject the punch notifications
                    </p>
                  </div>
                </div>
