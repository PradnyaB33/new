...
const NewCommunication = ({ handleClose, open, organisationId }) => {
  ...
  console.log("error ", errors.communication);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.error(error);
      handleAlert(true, "error", "An Error occurred create the communication");
    }
  };
  ...
  const handleSaveForLater = async (data) => {
    try {
      ...
      console.error(error);
      handleAlert(true, "error", "An Error occurred saved communication");
    }
  };
