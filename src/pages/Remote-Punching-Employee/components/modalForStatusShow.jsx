...
//     }
//     const handleComplete = (empId) => {
//         navigate(`/organisation/${organisationId}/remote-task/${empId}`)
//     }
//     return (
...
//                                                     <Button onClick={{ handleComplete }}>Completed</Button> : acceptedByEntry.status
                                ...
                                <tr className="border-b" key={`${taskItem._id}-${email.value}`}>
                                    ...
                                    <td className="py-3 px-2">
                                        {acceptedByEntry
                                            ? acceptedByEntry.status
                                                ? acceptedByEntry.status === "Completed" ?
                                                    <Button onClick={() => handleComplete(email.value)}>Completed</Button> : acceptedByEntry.status
                                                : acceptedByEntry.accepted
                                                    ? 'Accept'
                                                    : 'Reject'
                                            : 'Assigned'}
