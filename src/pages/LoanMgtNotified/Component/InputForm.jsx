...
const InputForm = () => {
  ...
  console.log("getApprovedRejectLoanDataByApprover", getApprovedRejectLoanDataByApprover);

  return (
    <div className="flex w-full flex-col gap-4">
      {getApprovedRejectLoanDataByApprover && getApprovedRejectLoanDataByApprover.length > 0 ? (
