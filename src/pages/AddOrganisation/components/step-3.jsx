...
const Step3 = ({ nextStep }) => {
  ...
  <div className="package-selection">
    <h3 className="text-gray-500 text-md font-semibold mb-4">Select Package Additions:</h3>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      {packagesArray.map((pkg) => (
        <div key={pkg.value} className={`border rounded-md shadow-sm p-3 transition-transform transform ${selectedPackages.includes(pkg.value) ? 'bg-blue-100 scale-105' : 'bg-white hover:bg-gray-100'}`} style={{ width: '260px', height: '50px' }}>
